...
!  MECHANICAL PARAMETERS:
   ...
   real(c_double) depe(maxr,maxz)               !time derivative of clad plastic effective strain (m/m)
   real(c_double) deph(maxr,maxz)               !time derivative of clad plastic hoop strain (m/m)
   real(c_double) depr(maxr,maxz)               !time derivative of clad plastic radial strain (m/m)
   real(c_double) depz(maxr,maxz)               !time derivative of clad plastic axial strain (m/m)
